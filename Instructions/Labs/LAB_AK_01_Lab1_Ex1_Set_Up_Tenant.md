...
**Note:** If you see an error message, "Fail to opt in, please refresh", Audit Loggins is still being enabled in the background and the message can safely be ignored.
